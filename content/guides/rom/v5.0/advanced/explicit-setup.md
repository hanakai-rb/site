...
> [!NOTE]
> **ROM & Frameworks:** Framework integrations **take care of the setup for you**. If you want to use ROM with a framework, please refer to specific instructions under [Getting Started](//guide/getting-started) section.
...
Keep in mind with this namespace strategy, each component must be located under a module matching the component's name:
...
> [!NOTE]
> Typically, you're going to use [repository command interface and changesets](//guide/repositories/quick-start); custom command classes are useful when the built-in command support in repositories doesn't meet your requirements.
