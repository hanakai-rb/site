...
If you enable the `:i18n` or `:yaml` messages backend in the [configuration](//page/configuration), you can define messages in a yaml file and use their identifiers instead of plain strings. Here's a sample yaml with a message for our `age` error:
...
- [Rules with key and base failures](//page/rules#key-failures)
