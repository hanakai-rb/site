...
Schemas are a crucial part of `dry-validation`, they pre-process the data before it's validated by [the rules](//page/rules) and can provide detailed error messages. By default, the exposed DSL for defining schemas uses [Dry Schema](//doc/dry/dry-schema) under the hood.
...
- [Dry Schema](//doc/dry/dry-schema) learn how to fully leverage schemas!
- [Dry Types](//doc/dry/dry-types) learn more about the coercion backend used in the schemas
- [rules](//page/rules) learn how to define validation rules in addition to schemas
