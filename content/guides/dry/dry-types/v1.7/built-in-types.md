...
Assuming you've defined your own `Types` module ([see instructions](//page/getting-started)):
...
> `Maybe` types are not available by default - they must be loaded using `Dry::Types.load_extensions(:maybe)`. See [Maybe extension](//page/extensions/maybe) for more information.
