...
If you want to use dry-system with Rails, it's recommended to use [dry-rails](//org_guide/dry/dry-rails) which sets up application container for you and provides additional features on top of it.
