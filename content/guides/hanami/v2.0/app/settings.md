...
These types are provided by [dry-types](https://hanakai.org/learn/dry/dry-types), and the `Types` module is generated for you automatically when you subclass `Hanami::Settings`.
...
To enforce additional contraints on settings, you can use a [constraint](https://hanakai.org/learn/dry/dry-types/constraints/) in your constructor type.
