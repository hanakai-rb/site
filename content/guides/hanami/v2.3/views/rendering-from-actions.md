...
When automatically rendering a view, the request's params hash will be passed directly to the view as its [input](//page/input-and-exposures).
...
Views rendered from actions make the action's current request available in their [context](//page/context). This means you can use the following methods inside your templates, parts and scopes:
