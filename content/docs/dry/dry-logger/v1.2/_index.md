...
- [Backends](//page/backends) - Configure multiple logging destinations
- [Formatters](//page/formatters) - Control output format (string, JSON, Rack)
- [Templates](//page/templates) - Customize log message format
- [Filtering](//page/filtering) - Filter sensitive data from logs
- [Context](//page/context) - Add request-scoped data to log entries
- [Tagged logging](//page/tagging) - Mark and filter log entries with tags
- [Crash handling](//page/crash-handling) - Customize behavior when logging itself crashes
- [Testing](//page/testing) - Test your application's logging
- [Examples](//page/examples) - Complete, realistic configuration examples
