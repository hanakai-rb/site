...
For complete, realistic configuration examples, see the [Examples](//page/examples) page.
...
Learn more about tagging in the [Tagging guide](//page/tagging).
...
For complete configuration examples showing templates in action, see the [Examples](//page/examples) page.
