...
Hanami’s database layer is based on [Ruby Object Mapper](https://hanakai.org/rom) (ROM), a mature and flexible data persistence toolkit for Ruby.
...
See [this forum post](https://discourse.hanakai.org/t/integrating-rom-into-hanami-2-2/971) to learn more about these various slice formations. What we’ve delivered in this beta matches exactly the proposal in this post.
...
dry-operation is the long-awaited successor to the venerable [dry-transaction](https://hanakai.org/learn/dry/dry-transaction) gem, and I’m deeply grateful to [Marc Busqué](https://github.com/waiting-for-dev) for building it. Even though it’s not quite fully released, we’re including it as a preview via a GitHub source in your new app’s `Gemfile`.
...
We’ve already updated our [getting started guides](https://guides.hanamirb.org/v2.2/introduction/getting-started/) to walk you through your first Hanami 2.2 app, database layer included. Please give this a try, then [let us know how you go](https://discourse.hanakai.org).
