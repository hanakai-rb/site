...
Our policy is informed by [LLVM's AI Tool Use Policy](https://llvm.org/docs/AIToolPolicy.html) and [Mastodon's AI Contribution Policy](https://github.com/mastodon/.github/blob/main/AI_POLICY.md).
